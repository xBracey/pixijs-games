...
const Shop = () => {
    const { backpack, maxBackpack, money, bounciness, maxBounciness, launchPower, maxLaunchPower, hasWings, purchaseUpgrade, setStatus } =
    ...
    const upgrades: Upgrade[] = [
        ...
        },
        {
            id: 'wings',
            name: 'Wings',
            description: 'Allows penguins to fly and gain extra distance!',
            cost: 10
        }
    ];
    ...
    return (
        <div className="flex items-center justify-center opacity-95">
            <div className="rounded-md bg-snow-500 p-4">
                    ...
                    <div className="grid grid-cols-1 gap-2 md:grid-cols-2">
                        {upgrades.map((upgrade) => {
                            ...
                            return (
                                <div
                                    key={upgrade.id}
                                    className={`rounded-lg border-2 bg-snow-400 p-2 transition-all ${
                                ...
                                >
                                    <div className="mb-4 text-center">
                                        <h3 className="mb-2 text-base font-bold text-snow-100">{upgrade.name}</h3>
                                        <p className="mb-4 text-xs text-snow-200">{upgrade.description}</p>
                                    </div>

                                    <div className="flex flex-col items-center justify-between gap-1">
                                        <span className="text-base font-bold text-snow-100">£{upgrade.cost.toFixed(2)}</span>
